...
namespace MakaevFilmTestApp.Controllers
{
    public class FilmsController : Controller
    {
        ...
        {
            return View("Index",await _context.Films.OrderBy(x=>x.FilmTitle).ToListAsync());
        }
        public async Task<IActionResult> ViewByPopular()
        {
            return View("Index", await _context.Films.OrderByDescending(x => x.Rate).ToListAsync());
        }
        public async Task<IActionResult> ViewByDate()
        {
        ...
        public async Task<IActionResult> Create([Bind("Id,FilmTitle,FilmDescription,DateProduction")] Film film)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FilmTitle,FilmDescription,DateProduction")] Film film)
        {
            if (id != film.Id)
            {
                return NotFound();
